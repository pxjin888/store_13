...
<div class="pageContent">
	...
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		...
		<tbody>
			<s:iterator value="#request.material_children">
			<tr>
				...
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({materialId:'<s:property value="materialId"/>', materialName:'<s:property value="materialName"/>', materialChildren:'包含物料:{物料id:<s:property value="materialChildrenId"/>,物料名称:<s:property value="materialChildrenName"/>,物料数量:<s:property value="materialChildrenNum"/>}'})" title="查找带回">选择</a>
				</td>
			</tr>
			</s:iterator>
		</tbody>
