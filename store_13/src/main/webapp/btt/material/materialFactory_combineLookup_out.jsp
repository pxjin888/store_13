...
<div class="pageContent">
	...
	<table class="table" layoutH="118" targetType="dialog" width="100%">
		...
		<tbody>
			...
			<tr>
				<td><input type="checkbox" name="materialId" value="{materialId:'<s:property value="key.materialId"/>', materialName:'<s:property value="key.materialName"/>', materialNum:'', materialProviderId:'', materialProviderName:'', materialPriceId:'', materialInputPrice:'', materialPartNum:''}"/></td>
				<td><s:property value="key.materialId"/></td>
				<td><s:property value="key.materialName"/></td>
				<td><s:property value="key.materialUnit"/></td>
				<td>现有库存：<s:property value="key.materialNum"/>,使用：<input name="materialNum" class="materialNum" type="text" size="1" onkeyup="changeMaterialNum(this)"></td>
				<td>
					<s:iterator value="value" id="lastStore">
					  ...
					  <input name="materialPartNum" class="materialPartNum" type="text" size="1" onkeyup="changeMaterialPartNum(this)" >
					  </span>
					</s:iterator>
				</td>
			</tr>
