				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="/material_list.action" target="navTab">物料信息</a>
							</li>
							
							<li><a href="/materialFactory_list.action" target="navTab">物料供应商</a>
							</li>
									
							<li><a href="/materialLog_list.action" target="navTab">物料出入记录</a>
							</li>
						</ul>
					</div>
					<div class="accordionHeader">
